...
- **💡 Rich AI Insights & Official Vendor Links**: Enriches calendar events with actionable checklists and direct official booking/tracking links (e.g. Colosseum tickets, Vatican Museums, package tracking, hotel portals).
...
│   ├── enrichment.py                # Batched AI event insights, official links, tennis coach
